test_that("createCodeCountsTable works", {
  ...
  code_counts |> colnames() |> expect_equal(c("domain", "concept_id", "calendar_year", "gender_concept_id", "age_decile", "event_counts",  "person_counts", "incidence_person_counts", "total_person_counts"))
